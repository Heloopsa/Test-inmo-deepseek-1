        ...
        <div className="border-t pt-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <input type="text" name="buyer_name" placeholder="Tu nombre" required
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20" />
            ...
            <textarea name="message" placeholder="Hola, me interesa esta propiedad. Me gustaría recibir más información..."
              rows={2} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20" />
